<template>
    <footer class="absolute bottom-0 left-0 w-full py-4 px-8 flex justify-between items-center z-50 border-t border-gray-950">
        <div class="flex flex-col space-y-2 text-custom-white-adventage text-sm">
