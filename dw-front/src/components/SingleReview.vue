<template>
  <div class="review flex flex-col items-center justify-center p-4 bg-custom-black-adventage rounded-xl shadow-lg w-[600px] h-fit text-custom-white-adventage bg-opacity-50 px-6 py-[19.2px] gap-y-2 border-bottom-custom-adventage z-50 relative">
