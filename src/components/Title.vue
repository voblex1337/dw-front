<template>
    ...
    <div class="shadow-lg  w-full max-w-full h-full flex flex-col items-center justify-center gap-y-2">
        ...
        <h1 class="text-center text-white text-6xl">Get DrainWalk Cleaner.</h1>
        <img src="@/assets/img/glow.png" class="absolute z-10 pointer-events-none">
        <h1 class="text-center text-6xl custom-gradient-text-title-main ">Unique product on market</h1>
